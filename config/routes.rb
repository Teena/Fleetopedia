Fleetopedia::Application.routes.draw do
  ...
  #post "/vehicles/:id" => "vehicles#create"  # usually a submitted form
  #get "/vehicles/:id/edit" => "vehicles#edit"
  #put "/vehicles/:id" => "vehicles#update" # usually a submitted form
